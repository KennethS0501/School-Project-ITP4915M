...
{
    public partial class frm_IThomePage : Form
    {
        int mov;
        int movX;
        int movY;
        ...
        public frm_IThomePage(String firstName, String lastName, String title, String accessName, int accessID, String department)
        {
            InitializeComponent();
