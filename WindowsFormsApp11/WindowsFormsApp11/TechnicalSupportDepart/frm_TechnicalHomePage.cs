...
{
    public partial class frm_TechnicalHomePage : Form
    {
        int mov;
        int movX;
        int movY;
        ...
        public frm_TechnicalHomePage(String firstName, String lastName, String title, String accessName, int accessID, String department)
        {
            InitializeComponent();
